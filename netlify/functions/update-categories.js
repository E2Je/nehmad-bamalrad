// Netlify Function: update categories in protocols.json
...
exports.handler = async (event) => {
  ...
  if (!categories) return { statusCode: 400, body: 'Missing categories' }
  ...
  if (updateRes.status !== 200 && updateRes.status !== 201) {
    return { statusCode: 500, body: 'Failed to update categories' }
  }
